...
with source as (
    ...
    select *,
    from {{ source('staging', 'county_natality_by_congenital_abnormalities') }}
...
renamed as (
    ...
    select
        ...
        {{ dbt.safe_cast("congenital_abnormality_checked_yn", api.Column.translate_type("integer")) }} as congenital_abnormality_checked_yn,
