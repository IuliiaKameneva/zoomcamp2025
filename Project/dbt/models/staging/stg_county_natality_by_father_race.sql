...
with source as (
    ...
    select *,
    from {{ source('staging', 'county_natality_by_father_race') }}
...
renamed as (
    ...
    select
        ...
        fathers_single_race,
        {{ dbt.safe_cast("fathers_single_race_code", api.Column.translate_type("integer")) }} as fathers_single_race_code,
