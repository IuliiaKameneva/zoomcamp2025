...
with source as (
    ...
    select *,
    from {{ source('staging', 'county_natality_by_mother_race') }}
...
renamed as (
    ...
    select
        ...
        mothers_single_race,
        {{ dbt.safe_cast("mothers_single_race_code", api.Column.translate_type("integer")) }} as mothers_single_race_code,
